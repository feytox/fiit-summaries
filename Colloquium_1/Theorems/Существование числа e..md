...
Рассмотрим также $n+1$ число: $1; 1 - \dfrac{1}{n}; 1 - \dfrac{1}{n}; ...; 1 - \dfrac{1}{n}$, тогда по неравенству о средних: $\dfrac{n+1-1}{n+1} \geq \sqrt[n+1]{\left(1 - \dfrac{1}{n}\right)^{n}} \Rightarrow \left(\dfrac{n}{n+1}\right)^{n+1} \geq \left(1 - \dfrac{1}{n}\right)^{n} \Rightarrow \left(\dfrac{n+1}{n}\right)^{n+1} \leq \left(\dfrac{n}{n-1}\right)^{n} \Rightarrow a_{n} \leq a_{n-1}$, а значит $a_{n}$ монотонно убывает.

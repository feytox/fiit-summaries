...
$$\begin{align*}V_{1} &= \{v \mid \mathcal{A}v \in \mathrm{Ker}~\mathcal{A}\} \\ V_{2} &= \{v \mid \mathcal{A}^{2}v \in \mathrm{Ker}~\mathcal{A}^{2}\} \\ &\dots \\ V_{k} &= \{v \mid \mathcal{A}^{k}v \in \mathrm{Ker}~\mathcal{A}^{k}\}\end{align*}$$

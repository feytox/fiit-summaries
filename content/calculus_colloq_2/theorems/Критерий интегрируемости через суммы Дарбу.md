...
Формулировка:
```spoiler-markdown
$f(x)$ - интегрируема на $[a, b]$ $\iff$ $\forall{\varepsilon > 0}~~ \exists{\delta_{\varepsilon} > 0}~~ \forall{\tau}\mathpunct{:}~~ \lambda(\tau) < \delta \Rightarrow \overline{S}_{\tau} - \underline{S}_{\tau} < \varepsilon$
```
...
$\Large\impliedby$
Знаем, что $\forall{\varepsilon > 0}~~ \exists{\delta_{\varepsilon} > 0}~~ \forall{\tau}\mathpunct{:}~~ \lambda(\tau) < \delta \Rightarrow \overline{S}_{\tau} - \underline{S}_{\tau} < \varepsilon$

Для [[Сумма Дарбу. Интеграл Дарбу#Интеграл Дарбу|верхнего интеграла Дарбу]] получаем: $\underline{S}_{\tau} \leq^{1} I^{*} \leq^{2} \overline{S}_{\tau}$
(1 - так как $\underline{S}_{\tau} \leq \overline{S}_{\tau}$, 2 - т.к. $\inf$)
